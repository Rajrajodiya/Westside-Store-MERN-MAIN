      ...
      <div className="container-fluid px-5">
        <div className="row">
          ...
          <div className="col-md-3 mb-4">
            ...
            <ul className="list-unstyled">
              ...
              <li><a href="# disabled">STORE LOCATOR</a></li>
              <li><a href="# disabled">MEDIA CENTER</a></li>
              <li><a href="# disabled">SITEMAP</a></li>
              <li><a href="# disabled">MEMBERSHIP</a></li>
            </ul>
          </div>
        ...
        <div className="row border-top pt-3 text-center">
          <div className="col-md-12">
            <a href="# disabled">TERMS & CONDITIONS</a> |
            <a href="# disabled"> PRIVACY POLICY</a> |
            <a href="# disabled"> RETURN POLICY</a>
          </div>
        </div>
